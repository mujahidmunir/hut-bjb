...
(function (f) {
    ...
    v.ext.buttons.copyHtml5 = {
        className: "buttons-copy buttons-html5 btn btn-danger btn-sm",
        text: function (a) {
    ...
    v.ext.buttons.csvHtml5 = {
        bom: !1,
        className: "buttons-csv buttons-html5 btn btn-danger btn-sm",
        available: function () {
    ...
    v.ext.buttons.excelHtml5 = {
        className: "buttons-excel buttons-html5  btn btn-danger btn-sm",
        available: function () {
    ...
    v.ext.buttons.pdfHtml5 = {
        className: "buttons-pdf buttons-html5 btn btn-danger btn-sm",
        available: function () {
            return g.FileReader !==
                w && (t || g.pdfMake)
        },
