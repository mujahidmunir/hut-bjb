            ...
            <div class="row">
                    ...
                    <div class="card card-block p-card">
                        <div class="profile-box">
                            <div class="profile-card rounded">
                                <img src="{{URL::to('images/news/thumb', $data->thumb)}}" alt="profile-bg" class="rounded d-block mx-auto img-fluid mb-3">
                ...
                <div class="col-lg-8">
                    <div class="card card-block mb-3">
                        ...
                        <div class="card-body">
                            <h5 class="mb-2"><u>Keterangan</u></h5>
                            <p class="mb-5">{{$data->syarat}}</p>
