        ...
        <div class="row">
                ...
                <div class="card card-block card-stretch card-height blog">
                    <div class="card-body">
                        <div class="image-block">
                            <img src="{{URL::to('assets/images/blog/07.jpg')}}" class="img-fluid rounded w-100" alt="blog-img">
                        </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="card card-block card-stretch card-height blog">
                    <div class="card-body">
                        <div class="image-block">
                            <img src="{{URL::to('assets/images/blog/08.jpg')}}" class="img-fluid rounded w-100" alt="blog-img">
                        </div>
                        <div class="blog-description mt-3">
                            <div class="blog-meta d-flex align-items-center justify-content-between mb-2">
                                <div class="date"><a href="#" tabindex="-1">March 21, 2020</a>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="card card-block card-stretch card-height blog">
                    <div class="card-body">
                        <div class="image-block">
                            <img src="{{URL::to('assets/images/blog/09.jpg')}}" class="img-fluid rounded w-100" alt="blog-img">
                        </div>
                        <div class="blog-description mt-3">
                            <div class="blog-meta d-flex align-items-center justify-content-between mb-2">
                                <div class="date"><a href="#" tabindex="-1">March 21, 2020</a>
                ...
                <div class="card card-block card-stretch card-height blog blog-date">
                    <div class="card-body">
                        <div class="image-block position-relative">
                            <img src="{{URL::to('assets/images/blog/10.jpg')}}" class="img-fluid rounded w-100" alt="blog-img">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="card card-block card-stretch card-height blog blog-date">
                    <div class="card-body">
                        <div class="image-block position-relative">
                            <img src="{{URL::to('assets/images/blog/11.jpg')}}" class="img-fluid rounded w-100" alt="blog-img">
                            <div class="blog-meta-date">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="card card-block card-stretch card-height blog blog-date">
                    <div class="card-body">
                        <div class="image-block position-relative">
                            <img src="{{URL::to('assets/images/blog/12.jpg')}}" class="img-fluid rounded w-100" alt="blog-img">
                            <div class="blog-meta-date">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="card card-block card-stretch card-height blog blog-comments">
                    <div class="card-body">
                        ...
                        <div class="image-block position-relative">
                            <img src="{{URL::to('assets/images/blog/13.jpg')}}" class="img-fluid rounded w-100" alt="blog-img">
                            <div class="blog-meta-date">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="card card-block card-stretch card-height blog blog-comments">
                    <div class="card-body">
                        ...
                        <div class="image-block position-relative">
                            <img src="{{URL::to('assets/images/blog/14.jpg')}}" class="img-fluid rounded w-100" alt="blog-img">
                            <div class="blog-meta-date">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="card card-block card-stretch card-height blog blog-comments">
                    <div class="card-body">
                        ...
                        <div class="image-block position-relative">
                            <img src="{{URL::to('assets/images/blog/15.jpg')}}" class="img-fluid rounded w-100" alt="blog-img">
                            <div class="blog-meta-date">
