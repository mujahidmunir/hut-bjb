                    ...
                    <div class="card" style="height: 100%">
                        ...
                        <div class="card-footer">
                            ...
                            <div class="float-right">
                                <button class="btn btn-success btn-lg" style="font-size: 3vh">Show Qr Code</button>
                                <a href="https://online.fliphtml5.com/sgafu/jqor/" style="font-size: 3vh" target="_blank" class="btn btn-primary btn-lg">Baca Selengkapnya</a>
                            </div>
                        </div>
                    </div>
