                    ...
                    <div class="card" style="height: 100%">
                        ...
                        <div class="card-footer">
                            ...
                            <div class="float-right">
                                <button class="btn btn-success btn-lg" style="height: 50px; width: 40%">Show Qr Code</button>
                                <a href="https://online.fliphtml5.com/sgafu/jqor/" style="height: 50px; width: 40%" target="_blank" class="btn btn-primary btn-lg">Baca Selengkapnya</a>
                            </div>
                        </div>
                    </div>
