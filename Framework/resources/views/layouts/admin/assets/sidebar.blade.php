<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
            ...
            <li class="nav-item mr-auto"><a class="navbar-brand" href="index-2.html"><span class="brand-logo">
                <svg viewbox="0 0 139 95" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="24">
                  ...
                  <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <h2 class="brand-text">Dashboard</h2></a>
            </li>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item {{'dashboard' == request()->path() ? 'active' : ''}}"><a class="d-flex align-items-center" href="{{URL::to('/dashboard')}}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Home</span></a>
            </li>
...
{{--                    <li class="{{'dashboard' == request()->path() ? 'active' : ''}}"><a class="d-flex align-items-center" href="{{url('dashboard')}}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Analytics">Analytics</span></a>--}}
{{--                    </li>--}}
{{--                    <li class="{{'/' == request()->path() ? 'active' : ''}}"><a class="d-flex align-items-center" href="{{url('/')}}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">eCommerce</span></a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--            </li>--}}
